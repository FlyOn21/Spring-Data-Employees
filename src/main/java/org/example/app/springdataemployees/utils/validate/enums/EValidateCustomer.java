package org.example.app.springdataemployees.utils.validate.enums;
...
public enum EValidateCustomer implements IValidateUnit {
    ...
    POSITION("Position must contain only letters and min length 3 characters", "^[A-Za-zА-Яа-яЁёІіЇїЄєҐґ]{3,}$"),
    IS_WORKING("Is working must be true or false", "^(true|false)$");
